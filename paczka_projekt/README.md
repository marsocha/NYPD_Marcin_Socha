Projekt służący do analizy danych z serwisu imdb. Dane można pobrać ze strony https://datasets.imdbws.com/ i jeśli chcemy uruchomić program należy utworzyć folder data i sciagnąć do niego pliki ze strony.
